...
import com.hhl.hhlandroidproject.ui.view.stickylistheaders.WrapperViewList.LifeCycleListener;
...
public class StickyListHeadersListView extends FrameLayout {
    ...
    public void setMenuCreator(SwipeMenuCreator menuCreator) {
        mList.setMenuCreator(menuCreator);
    }

    public void setOnMenuItemClickListener(
            WrapperViewList.OnMenuItemClickListener onMenuItemClickListener) {
        mList.setOnMenuItemClickListener(onMenuItemClickListener);
    }

    public void setOnSwipeListener(WrapperViewList.OnSwipeListener onSwipeListener) {
        mList.setOnSwipeListener(onSwipeListener);
    }
    ...
    public StickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mList.setScrollViewCallbacks(new WrapperObservableScorllViewCallbacks());
    ...
    private class WrapperObservableScorllViewCallbacks implements ObservableScrollViewCallbacks{
